...
$cases = @(
    ...
    # PHASE 7: EXTENDED VERIFICATION (THE FINAL 20 CASES)
...
$csvPath = "C:\Users\nikhil.chaudhari\OneDrive - Eduspark International Pvt. Ltd\Helpdesk\helpdesk\automation\testresults\Query_Configuration_TestCases_80.csv"
...
Write-Host "Full 80-case CSV file created at: $csvPath"
