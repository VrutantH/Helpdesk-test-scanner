...
const seedMasterData = async () => {
    try {
        ...
        const orgTypeCount = await master_data_1.OrganizationType.countDocuments();
        if (orgTypeCount === 0) {
            await master_data_1.OrganizationType.insertMany([
        ...
        const industryCount = await master_data_1.Industry.countDocuments();
        if (industryCount === 0) {
            await master_data_1.Industry.insertMany([
        ...
        const countryCount = await master_data_1.Country.countDocuments();
        if (countryCount === 0) {
            await master_data_1.Country.insertMany([
        ...
        const stateCount = await master_data_1.State.countDocuments();
        if (stateCount === 0) {
            await master_data_1.State.insertMany([
        ...
        const cityCount = await master_data_1.City.countDocuments();
        if (cityCount === 0) {
            await master_data_1.City.insertMany([
        ...
        const centerCount = await master_data_1.Center.countDocuments();
        if (centerCount === 0) {
            await master_data_1.Center.insertMany([
                {
                    key: 'mumbai_ho',
        ...
        const organizationCount = await master_data_1.Organization.countDocuments();
        if (organizationCount === 0) {
            await master_data_1.Organization.insertMany([
        ...
        const currencyCount = await master_data_1.Currency.countDocuments();
        if (currencyCount === 0) {
            await master_data_1.Currency.insertMany([
        ...
        const timezoneCount = await master_data_1.Timezone.countDocuments();
        if (timezoneCount === 0) {
            await master_data_1.Timezone.insertMany([
        ...
        const dateFormatCount = await master_data_1.DateFormat.countDocuments();
        if (dateFormatCount === 0) {
            await master_data_1.DateFormat.insertMany([
        ...
        const languageCount = await master_data_1.Language.countDocuments();
        if (languageCount === 0) {
            await master_data_1.Language.insertMany([
...
//# sourceMappingURL=seedMasterDataNew.js.map