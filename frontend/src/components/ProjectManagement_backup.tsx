          ...
          {loading ? (
            ...
            <div style={{
              ...
              <p style={{ 
                ...
                {getText('Get started by creating your first project to organize your helpdesk system', 'तुमची हेल्पडेस्क प्रणाली आयोजित करण्यासाठी तुमचा पहिला प्रकल्प तयार करून प्रारंभ करा', 'तुमची हेल्पडेस्क प्रणाली आयोजित करण्यासाठी तुमचा पहिला प्रकल्प तयार करून प्रारंभ करा')}
              </p>
            </div>
          ) : (
            <table style={{ 
              ...
              <thead>
                <tr style={{ background: '#F9FAFB', borderBottom: '1px solid #E5E7EB' }}>
                  ...
                  <th style={{ 
                    ...
                    {getText('Portal Name', 'पोर्टल नाव', 'पोर्टल नाव')}
                  </th>
                  <th style={{ 
                    padding: '12px 24px', 
                    textAlign: 'left', 
                    ...
                    {getText('Portal URL', 'पोर्टल URL', 'पोर्टल URL')}
                  </th>
                  <th style={{ 
                    padding: '12px 24px', 
                    textAlign: 'left', 
              ...
              <tbody>
                    <th style={{ padding: 'var(--spacing-3) var(--spacing-6)', textAlign: 'left', fontSize: 'var(--font-xs)', fontWeight: '600', color: 'var(--text-secondary)', textTransform: 'uppercase' }}>
                      {getText('Status', 'स्थिती', 'स्थिती')}
                    </th>
                    <th style={{ padding: 'var(--spacing-3) var(--spacing-6)', textAlign: 'left', fontSize: 'var(--font-xs)', fontWeight: '600', color: 'var(--text-secondary)', textTransform: 'uppercase' }}>
                      {getText('Created Date', 'तयार केलेली तारीख', 'तयार केलेली तारीख')}
